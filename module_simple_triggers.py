...
#sod chief empieza rentas con black smith
		...
		(try_begin),
			(party_slot_eq, ":center_no", slot_party_type, spt_castle),
			#(assign, ":cur_rents", -250), # Removed to make castle income better TML. F123 - Submod -> 1.41
#SoD Buildings Begin
			(try_begin),
				(party_slot_eq, ":center_no", slot_center_has_blacksmith, 1),
				(val_add, ":cur_rents", 100), # Increased blacksmith bonus to 100 TML. F123 - Submod -> 1.41
			(try_end),
#SDO BUILDINGS END
		(try_end),
...
###chief acaba
    ...
    (call_script, "script_change_player_honor", -2),
		...
		(store_mul, ":earnings", 10, "$g_num_prisoners"), #anadido coste de los guardias chief
...
#+freelancer start
  #  WEEKLY PAY AND CHECKS FOR UPGRADE
    ...
    (24 * 7, [
        ...
        (store_current_hours, "$freelancer_next_pay_time"),
