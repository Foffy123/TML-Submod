...
arena_tier1_opponents_to_beat = 3 #TML upped the melee fight prizes x5. F123 - Submod -> 1.41
arena_tier1_prize = 25
arena_tier2_opponents_to_beat = 6
arena_tier2_prize = 50
arena_tier3_opponents_to_beat = 10
arena_tier3_prize = 125
...
ACHIEVEMENT_MAN_HANDLER = 75, #F123 - 1.41 -> Submod
...
#Formation tweaks
formation_minimum_spacing	= 30 # chief cambiado # TML less spacing (down to 30 from 47). I assume this variable is used, didn't check but it sounds good and between it and the one below they're closer together now so I'm happy. F123 - Submod -> 1.41
...
armadura_pesada3_end = "itm_vikinglamellar2" # Shifted this up from cuir_bouilli so viking lamellars were no longer in heavy. TML. F123 - Submod -> 1.41 (All item changes)
armadura_pesada4_begin = "itm_mail_coat_1" # Changed this from cuir_bouilli because otherwise it was generating a nonsense check of is_between big number through small number. Does that hurt anything? Probably not, but it didn't do anything either. The whole code for these requiring 4 variables when they're all in one long list confuses me, but I didn't want to mess with it too much. TML
armadura_pesada4_end = "itm_vikinglamellar2" 
armadura_media_begin = "itm_vikinglamellar2" # This was actually already set to this, which is what made me think they may have been intended to be medium. TML
armadura_media_end = "itm_padded_jack_8_trig"
armadura_media2_begin = "itm_byrnie" # I notice that these are actually heavy armor ingame because the heavy list overwrites it just like it did for viking armor before, but didn't feel the need to change it. TML
