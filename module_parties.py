...
###############################################################  
  ...
  ("town_7","Caer_Ligualid",   icon_town_desert|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-12.238,3.375),[],120), #done
  ...
  ("town_27","Bebbanburh",     icon_town_desert|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-59.041,-47.416),[],0), #done
  ...
  ("town_32","Rath_Celtair",   icon_town_desert|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(50.49,25.48),[],298), #done

  ("town_33","Aileach",   icon_town_desert|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(82.338,-18.912),[],0), #done
  ...
  ("town_37","Duin_Foither",   icon_town_desert|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-52.34,-130.132),[],0), #done
...
#  Malabadi_Castle
  ...
  ("castle_19","Biedcanford",icon_castle_c|pf_castle, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-76.49,123.52),[],280),
...
# Tuavus   Pamir   vezona 
  ...
  ("village_49","Leodridan",  icon_village_1|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-88.28,126.60),[],10),
...
#plazas unicas chief sot
    ("celidon_forest","Ancient_Stones",icon_castle_snow_b|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(13.882,79.756),[]),
  ("hidden_valley","Rare Ruins",icon_town_snow|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-60.598,47.851),[]),
  ("iniau_hideout","Sacred_Grove",icon_castle_snow_b|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(93.052,90.85),[]),
...
###monasterios empieza
    ("monasterio1","Ad Candida Casam",icon_town_steppe|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(12.247,5.494),[]),
...
#  bridge_a
  ("Bridge_1","{!}1",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-73.203,33.023),[],98.59),
  ("Bridge_2","{!}2",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-59.032,-10.364),[],187.19),
  ("Bridge_3","{!}3",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-78.313,78.704),[],18.59),
  ("Bridge_4","{!}4",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-19.031,106.556),[],90),
  ("Bridge_5","{!}5",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-88.367,130.87),[],146.46),
  ("Bridge_6","{!}6",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-50.103,125.522),[],120),
  ("Bridge_7","{!}7",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-19.72,94.656),[],75),
  ("Bridge_8","{!}8",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(31.001,-59.269),[],28.07),
  ("Bridge_9","{!}9",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(101.064,70.063),[],41.67),
  ("Bridge_10","{!}10",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(8.234,-63.91),[],57.92),
  ("Bridge_11","{!}11",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-59.32,7.023),[],98.59),
  ("Bridge_12","{!}12",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-74.475,44.409),[],60.52),
  ("Bridge_13","{!}13",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-37.872,114.902),[],32.7),
#  ("Bridge_14","{!}14",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-145.19,143.25),[],75),
  ("Bridge_15","{!}15",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-4.034,83.36),[],15),
  ("Bridge_16","{!}16",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(88.312,44.449),[],69.38),
  ("Bridge_17","{!}17",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-33.041,153.498),[],81.46),
  ("Bridge_18","{!}18",icon_bridge_a|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(73.661,91.29),[],107.19),
  ("Bridge_19","{!}19",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(86.047,94.313),[],120),
